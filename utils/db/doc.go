...
//		"github.com/ntdat104/go-utils/utils/datetime"
//		database "github.com/ntdat104/go-utils/utils/db"
//		"github.com/ntdat104/go-utils/utils/logger"
//		"go.uber.org/zap"
//	)
//
...
//		if err := db.Get(&account, "SELECT * FROM account WHERE account.username = ?", "bob"); err != nil {
//			if err == sql.ErrNoRows {
...
//		resultUpdate, err := db.Exec("UPDATE account SET account.status = ?, account.updated_time = ? WHERE account.username = ?", 2, datetime.GetCurrentMiliseconds(), "bob")
//		if err != nil {
